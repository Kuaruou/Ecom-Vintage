            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <div class="form-group">
                  ...
                  <input
                    type="file" id="customFile" class="form-control" ref="files"
                    @change="uploadFile"/>
                </div>
                <img
...
export default {
  ...
  methods: {
    getProducts(page = 1) {
      const api = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/products?page=${page}`; //'https://vue-course-api.hexschool.io/api/pomme/products';
      const vm = this;
      vm.isLoading = true;
    ...
    updateProduct() {
      let api = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/product`; //'https://vue-course-api.hexschool.io/api/pomme/products';
      let httpMethod = "post";
      const vm = this;
      if (!vm.isNew) {
