    ...
    <div class="row mt-4">
      <div class="col-md-4 mb-4" v-for="item in products" :key="item.id">
        <div class="card border-0 shadow-sm h-100">
          <div
            style="height: 15rem; width: 60%; background-size: cover; background-position: center"
...
export default {
  ...
  methods: {
    getProducts(page = 1) {
      const vm = this;
      const url = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMPATH}/products`; //'https://vue-course-api.hexschool.io/api/pomme/products';
